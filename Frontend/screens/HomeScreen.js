            ...
            <View style={styles.card} key={listing}>
              ...
              >
                {Listings[page].map((color, index) => (
                  <View style={{backgroundColor: color, width: 0.9 * screenWidth, height: 0.7 * screenHeight, borderRadius: 20, alignItems: 'center', justifyContent: 'center', margin: 20, top: 0.09 * screenHeight}} key={index}>
